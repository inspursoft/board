define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/range_list", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/clipboard", "ace/lib/dom", "ace/editor"], function (e, a, t) {
    "use strict";
    ...
    var n = e("./lib/oop"), o = e("./lib/event_emitter").EventEmitter, l = e("./lib/lang"), h = e("./range").Range,
        p = e("./range_list").RangeList, r = e("./keyboard/hash_handler").HashHandler, s = e("./tokenizer").Tokenizer,
        c = e("./clipboard"), u = {
    ...
    (function () {
        n.implement(this, o), this.getTokenizer = function () {
            ...
            var t = {
                regex: "/(" + e("/") + "+)/", onMatch: function (e, t, i) {
                    var n = i[0];
                    return n.fmtString = !0, n.guard = e.slice(1, -1), n.flag = ""
                }, next: "formatString"
            };
            return d.$tokenizer = new s({
                start: [{
                    ...
                    regex: /\$\{[\dA-Z_a-z]+/, onMatch: function (e, t, i) {
                        var n = o(e.substr(1));
                ...
                formatString: [{
                    ...
                    regex: /\$(?:\d+|\w+)/, onMatch: function (e, t, i) {
        ...
        }, this.variables = u, this.tmStrFormat = function (e, t, s) {
            if (!t.fmt) return e;
            var i = t.flag || "", n = t.guard;
            n = new RegExp(n, i.replace(/[^gim]/g, ""));
            var a = "string" == typeof t.fmt ? this.tokenizeTmSnippet(t.fmt, "formatString") : t.fmt, c = this;
            return e.replace(n, function () {
                var e = c.variables.__;
                c.variables.__ = [].slice.call(arguments);
                for (var t = c.resolveVariables(a, s), i = "E", n = 0; n < t.length; n++) {
                    var o = t[n];
                    if ("object" == typeof o) if (t[n] = "", o.changeCase && o.local) {
                        var r = t[n + 1];
                        r && "string" == typeof r && ("u" == o.changeCase ? t[n] = r[0].toUpperCase() : t[n] = r[0].toLowerCase(), t[n + 1] = r.substr(1))
                    } else o.changeCase && (i = o.changeCase); else "U" == i ? t[n] = o.toUpperCase() : "L" == i && (t[n] = o.toLowerCase())
                }
                ...
                if ("string" != typeof a) {
                    if (a) {
                        if (r = !1, a.fmtString) {
                            ...
                            -1 == c && (c = i.length), a.fmt = i.slice(s + 1, c), s = c
                        }
                        if (a.text) {
                            var l = this.getVariableValue(e, a.text, o) + "";
                            a.fmtString && (l = this.tmStrFormat(l, a, e)), a.formatFunction && (l = this.tmFormatFunction(l, a, e)), l && !a.ifEnd ? (n.push(l), t(a)) : !l && a.ifEnd && t(a.ifEnd)
                        } else a.elseEnd ? t(a.elseEnd) : null != a.tabstopId ? n.push(a) : null != a.changeCase && n.push(a)
                    }
                } else n.push(a), "\n" == a ? (r = !0, o = "") : r && (o = /^\t*/.exec(a)[0], r = /\S/.test(a))
            }
            return n
            ...
            var n = e.getCursorPosition(), o = e.session.getLine(n.row), r = e.session.getTabString(),
                s = o.match(/^\s*/)[0];
            ...
            for (var l = {}, h = 0; h < a.length; h++) {
                var p = a[h];
                if ("object" == typeof p) {
                    var u = p.tabstopId, d = c[u], g = a.indexOf(p, h + 1);
                    if (l[u]) l[u] === p && (delete l[u], Object.keys(l).forEach(function (e) {
                        d.parents[e] = !0
                    })); else {
                        l[u] = p;
                        var f = d.value;
                        "string" != typeof f ? f = i(f) : p.fmt && (f = this.tmStrFormat(f, p, e)), a.splice.apply(a, [h + 1, Math.max(0, g - h)].concat(f, p)), -1 === d.indexOf(p) && d.push(p)
                    }
                }
            }
            var m = 0, b = 0, v = "";
            a.forEach(function (e) {
                if ("string" == typeof e) {
                    var t = e.split("\n");
                    1 < t.length ? (b = t[t.length - 1].length, m += t.length - 1) : b += e.length, v += e
                } else e && (e.start ? e.end = {row: m, column: b} : e.start = {row: m, column: b})
            });
            var x = e.getSelectionRange(), T = e.session.replace(x, v), w = new S(e),
        ...
        }, this.snippetMap = {}, this.snippetNameMap = {}, this.register = function (e, n) {
            function o(e) {
            ...
            function t(e) {
                e.scope || (e.scope = n || "_"), n = e.scope, s[n] || (s[n] = [], a[n] = {});
                var t = a[n];
                if (e.name) {
                    var i = t[e.name];
                    i && c.unregister(i), t[e.name] = e
                }
                s[n].push(e), e.tabTrigger && !e.trigger && (!e.guard && /^\w/.test(e.tabTrigger) && (e.guard = "\\b"), e.trigger = l.escapeRegExp(e.tabTrigger)), (e.trigger || e.guard || e.endTrigger || e.endGuard) && (e.startRe = r(e.trigger, e.guard, !0), e.triggerRe = new RegExp(e.trigger), e.endRe = r(e.endTrigger, e.endGuard, !0), e.endTriggerRe = new RegExp(e.endTrigger))
            }

            var s = this.snippetMap, a = this.snippetNameMap, c = this;
            (e = e || []) && e.content ? t(e) : Array.isArray(e) && e.forEach(t), this._signal("registerSnippets", {scope: n})
        }, this.unregister = function (e, o) {
            function t(e) {
                var t = s[e.scope || o];
                if (t && t[e.name]) {
                    delete t[e.name];
                    var i = r[e.scope || o], n = i && i.indexOf(e);
                    0 <= n && i.splice(n, 1)
                }
            }

            var r = this.snippetMap, s = this.snippetNameMap;
    ...
    var S = function (e) {
        ...
        (e.tabstopManager = this).$onChange = this.onChange.bind(this), this.$onChangeSelection = l.delayedCall(this.onChangeSelection.bind(this)).schedule, this.$onChangeSession = this.onChangeSession.bind(this), this.$onAfterExec = this.onAfterExec.bind(this), this.attach(e)
    };
    (function () {
        this.attach = function (e) {
            ...
            for (var t = "r" == e.action[0], i = this.selectedTabstop || {}, n = i.parents || {}, o = (this.tabstops || []).slice(), r = 0; r < o.length; r++) {
                var s = o[r], a = s == i || n[s.index];
                if (s.rangeList.$bias = a ? 0 : 1, "remove" == e.action && s !== i) {
                    var c = s.parents && s.parents[i.index], l = s.rangeList.pointIndex(e.start, c);
                    l = l < 0 ? -l - 1 : l + 1;
                    var h = s.rangeList.pointIndex(e.end, c);
                    h = h < 0 ? -h - 1 : h - 1;
                    for (var p = s.rangeList.ranges.slice(l, h), u = 0; u < p.length; u++) this.removeRange(p[u])
                }
            ...
            if (e && e.hasLinkedRanges && e.firstNonLinked) {
                this.$inChange = !0;
                for (var t = this.editor.session, i = t.getTextRange(e.firstNonLinked), n = 0; n < e.length; n++) {
                    var o = e[n];
                    if (o.linked) {
                        var r = o.original, s = a.snippetManager.tmStrFormat(i, r, this.editor);
                        t.replace(o, s)
                    }
                }
                this.$inChange = !1
            ...
            if (this.editor) {
                for (var e = this.editor.selection.lead, t = this.editor.selection.anchor, i = this.editor.selection.isEmpty(), n = 0; n < this.ranges.length; n++) if (!this.ranges[n].linked) {
            ...
            if (t && this.addTabstopMarkers(t), this.index = e, (t = this.tabstops[this.index]) && t.length) {
                ...
                if (this.editor.inVirtualSelectionMode) this.editor.selection.setRange(i); else {
            ...
            var c = [this.index + 1, 0], l = this.ranges;
            e.forEach(function (e, t) {
                for (var i = this.$openTabstops[t] || e, n = 0; n < e.length; n++) {
                    var o = e[n], r = h.fromPoints(o.start, o.end || o.start);
                    g(r.start, s), g(r.end, s), r.original = o, r.tabstop = i, l.push(r), i != e ? i.unshift(r) : i[n] = r, o.fmtString || i.firstNonLinked && a ? (r.linked = !0, i.hasLinkedRanges = !0) : i.firstNonLinked || (i.firstNonLinked = r)
                }
                i.firstNonLinked || (i.hasLinkedRanges = !1), i === e && (c.push(i), this.$openTabstops[t] = i), this.addTabstopMarkers(i), i.rangeList = i.rangeList || new p, i.rangeList.$bias = 0, i.rangeList.addList(i)
            ...
            -1 != t && e.tabstop.splice(t, 1), -1 != (t = this.ranges.indexOf(e)) && this.ranges.splice(t, 1), -1 != (t = e.tabstop.rangeList.ranges.indexOf(e)) && e.tabstop.splice(t, 1), this.editor.session.removeMarker(e.markerId), e.tabstop.length || (-1 != (t = this.tabstops.indexOf(e.tabstop)) && this.tabstops.splice(t, 1), this.tabstops.length || this.detach())
        }, this.keyboardHandler = new r, this.keyboardHandler.bindKeys({
            Tab: function (e) {
                a.snippetManager && a.snippetManager.expandWithTab(e) || (e.tabstopManager.tabNext(1), e.renderer.scrollCursorIntoView())
    ...
    e("./lib/dom").importCssString(".ace_snippet-marker {    -moz-box-sizing: border-box;    box-sizing: border-box;    background: rgba(194, 193, 208, 0.09);    border: 1px dotted rgba(211, 208, 235, 0.62);    position: absolute;}"), a.snippetManager = new d;
...
}), define("ace/autocomplete/popup", ["require", "exports", "module", "ace/virtual_renderer", "ace/editor", "ace/range", "ace/lib/event", "ace/lib/lang", "ace/lib/dom"], function (e, t, i) {
    "use strict";
    ...
    var n = e("../virtual_renderer").VirtualRenderer, o = e("../editor").Editor, l = e("../range").Range,
        p = e("../lib/event"), d = e("../lib/lang"), g = e("../lib/dom");
    g.importCssString(".ace_editor.ace_autocomplete .ace_marker-layer .ace_active-line {    background-color: #CAD6FA;    z-index: 1;}.ace_dark.ace_editor.ace_autocomplete .ace_marker-layer .ace_active-line {    background-color: #3a674e;}.ace_editor.ace_autocomplete .ace_line-hover {    border: 1px solid #abbffe;    margin-top: -1px;    background: rgba(233,233,253,0.4);    position: absolute;    z-index: 2;}.ace_dark.ace_editor.ace_autocomplete .ace_line-hover {    border: 1px solid rgba(109, 150, 13, 0.8);    background: rgba(58, 103, 78, 0.62);}.ace_completion-meta {    opacity: 0.5;    margin: 0.9em;}.ace_completion-message {    color: blue;}.ace_editor.ace_autocomplete .ace_completion-highlight{    color: #2d69c7;}.ace_dark.ace_editor.ace_autocomplete .ace_completion-highlight{    color: #93ca12;}.ace_editor.ace_autocomplete {    width: 300px;    z-index: 200000;    border: 1px lightgray solid;    position: fixed;    box-shadow: 2px 3px 5px rgba(0,0,0,.2);    line-height: 1.4;    background: #fefefe;    color: #111;}.ace_dark.ace_editor.ace_autocomplete {    border: 1px #484747 solid;    box-shadow: 2px 3px 5px rgba(0, 0, 0, 0.51);    line-height: 1.4;    background: #25282c;    color: #c1c1c1;}", "autocompletion.css"), t.AcePopup = function (e) {
        var t = g.createElement("div"), u = new c(t);
        e && e.appendChild(t), t.style.display = "none", u.renderer.content.style.cursor = "default", u.renderer.setStyle("ace_autocomplete"), u.setOption("displayIndentGuides", !1), u.setOption("dragDelay", 150);

        function i() {
        }

        u.focus = i, u.$isFocused = !0, u.renderer.$cursorLayer.restartTimer = i, u.renderer.$cursorLayer.element.style.opacity = 0, u.renderer.$maxLines = 8, u.renderer.$keepTextAreaAtCursor = !1, u.setHighlightActiveLine(!1), u.session.highlight(""), u.session.$searchHighlight.clazz = "ace_highlight-marker", u.on("mousedown", function (e) {
            var t = e.getDocumentPosition();
            u.selection.moveToPosition(t), o.start.row = o.end.row = t.row, e.stop()
        });
        var h, n = new l(-1, 0, -1, 1 / 0), o = new l(-1, 0, -1, 1 / 0);
        o.id = u.session.addMarker(o, "ace_active-line", "fullLine"), u.setSelectOnHover = function (e) {
            e ? n.id && (u.session.removeMarker(n.id), n.id = null) : n.id = u.session.addMarker(n, "ace_line-hover", "fullLine")
        }, u.setSelectOnHover(!1), u.on("mousemove", function (e) {
            if (h) {
                if (h.x != e.x || h.y != e.y) {
                    (h = e).scrollTop = u.renderer.scrollTop;
                    var t = h.getDocumentPosition().row;
                    n.start.row != t && (n.id || u.setRow(t), s(t))
                }
            } else h = e
            ...
            if (h && -1 != n.start.row) {
                ...
                n.id || u.setRow(e), s(e, !0)
            }
        }), u.renderer.on("afterRender", function () {
            var e = u.getRow(), t = u.renderer.$textLayer, i = t.element.childNodes[e - t.config.firstRow];
            i !== t.selectedNode && t.selectedNode && g.removeCssClass(t.selectedNode, "ace_selected"), (t.selectedNode = i) && g.addCssClass(i, "ace_selected")
        });
        ...
        var s = function (e, t) {
            e !== n.start.row && (n.start.row = n.end.row = e, t || u.session._emit("changeBackMarker"), u._emit("changeHoverMarker"))
        };
        u.getHoveredRow = function () {
            return n.start.row
        }, p.addListener(u.container, "mouseout", r), u.on("hide", r), u.on("changeSelection", r), u.session.doc.getLength = function () {
            return u.data.length
        }, u.session.doc.getLine = function (e) {
            var t = u.data[e];
            return "string" == typeof t ? t : t && t.value || ""
        };
        var a = u.session.bgTokenizer;
        return a.$tokenizeRow = function (e) {
            function t(e, t) {
            ...
            for (var o = i.caption || i.value || i.name, r = o.toLowerCase(), s = (u.filterText || "").toLowerCase(), a = 0, c = 0, l = 0; l <= s.length; l++) if (l != c && (i.matchMask & 1 << l || l == s.length)) {
                var h = s.slice(c, l);
                c = l;
                var p = r.indexOf(h, a);
                if (-1 == p) continue;
                t(o.slice(a, p), ""), a = p + h.length, t(o.slice(p, a), "completion-highlight")
            }
            return t(o.slice(a, o.length), ""), i.meta && n.push({
                type: "completion-meta",
                value: i.meta
            }), i.message && n.push({type: "completion-message", value: i.message}), n
        }, a.$updateOnChange = i, a.start = i, u.session.$computeWidth = function () {
            return this.screenWidth = 0
        }, u.isOpen = !1, u.isTopdown = !1, u.autoSelect = !0, u.filterText = "", u.data = [], u.setData = function (e, t) {
            u.filterText = t || "", u.setValue(d.stringRepeat("\n", e.length), -1), u.data = e || [], u.setRow(0)
        }, u.getData = function (e) {
            return u.data[e]
        }, u.getRow = function () {
            return o.start.row
        }, u.setRow = function (e) {
            e = Math.max(this.autoSelect ? 0 : -1, Math.min(this.data.length, e)), o.start.row != e && (u.selection.clearSelection(), o.start.row = o.end.row = e || 0, u.session._emit("changeBackMarker"), u.moveCursorTo(e || 0, 0), u.isOpen && u._signal("select"))
        }, u.on("changeSelection", function () {
            u.isOpen && u.setRow(u.selection.lead.row), u.renderer.scrollCursorIntoView()
        }), u.hide = function () {
            this.container.style.display = "none", this._signal("hide"), u.isOpen = !1
        }, u.show = function (e, t, i) {
            var n = this.container, o = window.innerHeight, r = window.innerWidth, s = this.renderer,
                a = s.$maxLines * t * 1.4, c = e.top + this.$borderSize;
            o / 2 < c && !i && o < c + t + a ? (s.$maxPixelHeight = c - 2 * this.$borderSize, n.style.top = "", n.style.bottom = o - c + "px", u.isTopdown = !1) : (c += t, s.$maxPixelHeight = o - c - .2 * t, n.style.top = c + "px", n.style.bottom = "", u.isTopdown = !0), n.style.display = "";
            var l = e.left;
            l + n.offsetWidth > r && (l = r - n.offsetWidth), n.style.left = l + "px", this._signal("show"), h = null, u.isOpen = !0
        }, u.goTo = function (e) {
            var t = this.getRow(), i = this.session.getLength() - 1;
            switch (e) {
                case"up":
                    t = t <= 0 ? i : t - 1;
                    break;
    ...
    t.retrievePrecedingIdentifier = function (e, t, i) {
        ...
        i = i || r;
        for (var n = [], o = t; o < e.length && i.test(e[o]); o++) n.push(e[o]);
        return n
...
}), define("ace/autocomplete", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/autocomplete/popup", "ace/autocomplete/util", "ace/lib/lang", "ace/lib/dom", "ace/snippets", "ace/config"], function (e, t, i) {
    "use strict";

    function n() {
        this.autoInsert = !1, this.autoSelect = !0, this.exactMatch = !1, this.gatherCompletionsId = 0, this.keyboardHandler = new o, this.keyboardHandler.bindKeys(this.commands), this.blurListener = this.blurListener.bind(this), this.changeListener = this.changeListener.bind(this), this.mousedownListener = this.mousedownListener.bind(this), this.mousewheelListener = this.mousewheelListener.bind(this), this.changeTimer = s.delayedCall(function () {
            this.updateCompletions(!0)
        }.bind(this)), this.tooltipTimer = s.delayedCall(this.updateDocTooltip.bind(this), 50)
    }

    var o = e("./keyboard/hash_handler").HashHandler, r = e("./autocomplete/popup").AcePopup,
        l = e("./autocomplete/util"), s = e("./lib/lang"), a = e("./lib/dom"), c = e("./snippets").snippetManager,
        h = e("./config");
    (function () {
        this.$init = function () {
            ...
            if (this.popup.setRow(this.autoSelect ? 0 : -1), i) i && !t && this.detach(); else {
                ...
                var o = n.layerConfig.lineHeight, r = n.$cursorLayer.getPixelPosition(this.base, !0);
            ...
            if (e.completer && e.completer.insertMatch) e.completer.insertMatch(this.editor, e); else {
                if (this.completions.filterText) for (var i, n = this.editor.selection.getAllRanges(), o = 0; i = n[o]; o++) i.start.column -= this.completions.filterText.length, this.editor.session.remove(i);
            ...
            var o = i.getSession(), r = i.getCursorPosition(), s = l.getCompletionPrefix(i);
            this.base = o.doc.createAnchor(r.row, r.column - s.length), this.base.$insertRight = !0;
            var a = [], c = i.completers.length;
            return i.completers.forEach(function (e, t) {
                e.getCompletions(i, o, r, s, function (e, t) {
                    !e && t && (a = a.concat(t)), n(null, {
            ...
            if (s && this.base && this.completions) {
                ...
                return (this.completions.setFilter(i), this.completions.filtered.length) ? 1 != this.completions.filtered.length || this.completions.filtered[0].value != i || this.completions.filtered[0].snippet ? void this.openPopup(this.editor, i, s) : this.detach() : this.detach()
            }
            if (e && e.matches) {
                t = this.editor.getSelectionRange().start;
                return this.base = this.editor.session.doc.createAnchor(t.row, t.column), this.base.$insertRight = !0, this.completions = new p(e.matches), this.openPopup(this.editor, "", s)
            }
            var a = this.gatherCompletionsId;
            this.gatherCompletions(this.editor, function (e, t) {
                var i = function () {
                    if (t.finished) return this.detach()
                }.bind(this), n = t.prefix, o = t && t.matches;
                if (!o || !o.length) return i();
                if (0 === n.indexOf(t.prefix) && a == this.gatherCompletionsId) {
                    this.completions = new p(o), this.exactMatch && (this.completions.exactMatch = !0), this.completions.setFilter(n);
                    var r = this.completions.filtered;
                    return r.length && (1 != r.length || r[0].value != n || r[0].snippet) ? this.autoInsert && 1 == r.length && t.finished ? this.insertMatch(r[0]) : void this.openPopup(this.editor, n, s) : i()
                }
            }.bind(this))
            ...
            }), n || "string" == typeof i || (n = i), "string" == typeof n && (n = {docText: n}), n && (n.docHTML || n.docText) ? void this.showDocTooltip(n) : this.hideDocTooltip()) : this.hideDocTooltip()
    ...
    }).call(n.prototype), n.for = function (e) {
        return e.completer || (h.get("sharedPopups") ? (n.$shared || (n.$sharedInstance = new n), e.completer = n.$sharedInstance) : (e.completer = new n, e.once("destroy", function (e, t) {
            t.completer.destroy()
        }))), e.completer
    }, n.startCommand = {
            ...
            e:for (var r, s = 0; r = e[s]; s++) {
                ...
                if (a) {
                    ...
                    if (this.exactMatch) {
                        ...
                        if (-1 < d) u = d; else for (var g = 0; g < t.length; g++) {
                            var f = a.indexOf(o[g], h + 1), m = a.indexOf(n[g], h + 1);
                            if ((c = 0 <= f && (m < 0 || f < m) ? f : m) < 0) continue e;
                            0 < (l = c - h - 1) && (-1 === h && (u += 10), u += l, p |= 1 << g), h = c
                        }
                    }
    ...
    }).call(p.prototype), t.Autocomplete = n, t.FilteredList = p
}), define("ace/autocomplete/text_completer", ["require", "exports", "module", "ace/range"], function (e, t, i) {
    function s(e, t) {
        var i, o = (i = t, e.getTextRange(n.fromPoints({row: 0, column: 0}, i)).split(c).length - 1),
            r = e.getValue().split(c), s = Object.create(null), a = r[o];
        return r.forEach(function (e, t) {
            if (e && e !== a) {
                var i = Math.abs(o - t), n = r.length - i;
                s[e] ? s[e] = Math.max(n, s[e]) : s[e] = n
            }
        }), s
    }

    var n = e("../range").Range, c = /[^a-zA-Z_0-9\$\-\u00C0-\u1FFF\u2C00-\uD7FF\w]+/;
...
}), define("ace/ext/language_tools", ["require", "exports", "module", "ace/snippets", "ace/autocomplete", "ace/config", "ace/lib/lang", "ace/autocomplete/util", "ace/autocomplete/text_completer", "ace/editor", "ace/config"], function (e, t, i) {
    "use strict";
    var l = e("../snippets").snippetManager, o = e("../autocomplete").Autocomplete, n = e("../config"),
        r = e("../lib/lang"), s = e("../autocomplete/util"), a = e("../autocomplete/text_completer"), c = {
            ...
            getCompletions: function (e, t, i, n, o) {
                var r = [], s = t.getTokenAt(i.row, i.column);
                s && s.type.match(/(tag-name|tag-open|tag-whitespace|attribute-name|attribute-value)\.xml$/) ? r.push("html-tag") : r = l.getActiveScopes(e);
                var a = l.snippetMap, c = [];
    ...
    t.setCompleters = function (e) {
        ...
        p.push(e)
    }, t.textCompleter = a, t.keyWordCompleter = c, t.snippetCompleter = h;
    ...
    function d(e) {
        ...
        if ("backspace" === e.command.name) i && !s.getCompletionPrefix(t) && t.completer.detach(); else if ("insertstring" === e.command.name) {
    ...
    var g = {
        ...
        var t = e.$id;
        l.files || (l.files = {}), m(t), e.modes && e.modes.forEach(f)
    }, m = function (t) {
        if (t && !l.files[t]) {
            var e = t.replace("mode", "snippets");
            l.files[t] = {}, n.loadModule(e, function (e) {
    ...
    e("../config").defineOptions(b.prototype, "editor", {
        enableBasicAutocompletion: {
            ...
            set: function (e) {
                e ? (this.completers || (this.completers = Array.isArray(e) ? e : p), this.commands.on("afterExec", d)) : this.commands.removeListener("afterExec", d)
            }, value: !1
        }, enableSnippets: {
            set: function (e) {
                e ? (this.commands.addCommand(g), this.on("changeMode", u), u(0, this)) : (this.commands.removeCommand(g), this.off("changeMode", u))
            }, value: !1
        }
    })
