...
export const RouteSignIn = 'board/account/sign-in';
export const RouteSignUp = 'board/account/sign-up';
export const RouteForgotPassword = 'board/account/forgot-password';
export const RouteDashboard = "board/dashboard";
export const RouteServices = "board/services";
export const RouteHelm = "board/helm";
export const RouteRepoList = "repo-list";
export const RouteReleaseList = "release-list";
export const RouteProjects = "board/projects";
export const RouteNodes = "board/nodes";
export const RouteImages = "board/images";
export const RouteTrainingJob = "board/training-job";
export const RouteResource = "board/resource";
export const RouteConfigMap = "config-map";
export const RouteUserCenters = "board/user-center";
export const RouteAudit = "board/audit";
export const RouteKibana = "board/kibana-url";
export const RouteProfile = "board/profile";
export const RouteStorage = "board/storage";
