export const LANG_EN_US = {
  ...
  "RESOURCE":{
    ...
    "CONFIG_MAP_LIST_NAMESPACE":"NameSpace",
    ...
    "CONFIG_MAP_LIST_DELETE_SUCCESS":"Delete config map success.",
    "CREATE_CONFIG_MAP_TITLE":"Create config map",
    "CREATE_CONFIG_MAP_SUCCESS":"Create config map success.",
    ...
    "CONFIG_MAP_DETAIL_NAMESPACE":"Namespace",
  ...
  "NODE": {
    ...
    "NODE_GROUP_CREATE_PATTERN_MESSAGE": "Made of numbers or uppercase letter or lowercase letter or '.','-','_' character supported in the middle.",
