export const LANG_EN_US = {
  ...
  "SERVICE": {
    ...
    "STEP_3_EXTERNAL_MESSAGE":"You should drag at least one port to node.",
    "STEP_3_AFFINITY_MESSAGE":"Either affinity group or anti-affinity group should not be empty.",
    "STEP_3_AFFINITY_SETTING":"Set affinity",
