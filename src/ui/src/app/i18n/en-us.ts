export const LANG_EN_US = {
  ...
  "SERVICE": {
    ...
    "STEP_3_DANGER_MESSAGE":"Warning:It does't exist any port for external to use in all containers, the next button will be disable.",
    "STEP_3_EXTERNAL_MESSAGE":"You must be add one external service at least,and check that port.",
    "STEP_3_AFFINITY_MESSAGE":"Affinity group/reverse affinity group can't empty",
    "STEP_3_AFFINITY_SETTING":"Affinity setting",
    "STEP_3_AFFINITY_GROUP":"Affinity group",
    "STEP_3_REVERSE_AFFINITY_GROUP":"Reverse affinity group",
    "STEP_3_CONTAINER_DESCRIPTION":"(drag item to right for set node port)",
    "STEP_3_AFFINITY_DESCRIPTION":"(drag item to right for set affinity/reverse affinity)",
