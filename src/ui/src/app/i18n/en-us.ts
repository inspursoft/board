export const LANG_EN_US = {
  ...
  "JOB":{
    ...
    "JOB_CREATE_JOB_NAME_PATTERN_NSG":"Made of lower case alphanumeric characters, support use '.' and '-' as space character.",
  ...
  "RESOURCE":{
    ...
    "CREATE_CONFIG_MAP_NAME_PATTERN":"Made of lower case alphanumeric characters, support use '.' and '-' as space character.",
