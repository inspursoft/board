export const LANG_EN_US = {
  ...
  "SERVICE": {
    ...
    "STEP_3_DANGER_MESSAGE":"It does't exist any port for external to use in all containers, so the next button will be disable.",
    "STEP_3_EXTERNAL_MESSAGE":"You should drag one item from container port to node port at least.",
