export const LANG_ZH_CN = {
  ...
  "SERVICE": {
    ...
    "STEP_2_SELECT_IMAGE_TEMP":"选择镜像模版",
    "STEP_2_BASE_IMAGE":"基础镜像",
    "STEP_2_PULL_IMAGE":"拉取镜像",
    "STEP_2_NEW_IMAGE_NAME":"新建镜像名称",
    "STEP_2_IMAGE_TAG":"镜像标签",
    "STEP_2_IMAGE_ENTRYPOINT":"镜像进入点",
    "STEP_2_IMAGE_ENV":"镜像环境变量",
    ...
    "STEP_2_UPLOAD_FAILED":"上传文件失败。",
    "STEP_2_UPDATE_FILE_LIST_FAILED":"获取文件列表失败。",
    "STEP_2_UPDATE_DOCKER_FILE_FAILED":"获取DockerFile内容失败。",
    "STEP_2_UPDATE_IMAGE_LIST_FAILED":"更新镜像列表失败。",
    "STEP_2_BUILD_IMAGE_FAILED":"构建自定义镜像失败。",
