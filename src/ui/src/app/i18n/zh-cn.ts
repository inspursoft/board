export const LANG_ZH_CN = {
  ...
  "ACCOUNT": {
    ...
    "FORGOT_PASSWORD_ERROR_MSG":"用户名或邮箱不能为空",
    "USERNAME": "用户名",
    "REALNAME":"真实姓名",
  ...
  "SERVICE": {
    ...
    "STEP_3_CPU":"Cpu",
    "STEP_3_MEMORY":"内存",
    "STEP_3_WORK_DIRECTOR":"﻿请输入工作目录:/usr/local/bin",
    "STEP_3_STORAGE_VOLUME":"﻿配置外部存储卷",
    "STEP_3_ENVIRONMENT_VARIABLES":"﻿请输入环境变量定义:﻿VERSION = 1.0",
    "STEP_3_PORT_CONTAINER":"请输入容器的服务端口:80",
