export const LANG_ZH_CN = {
  ...
  "SERVICE": {
    ...
    "STEP_3_PUBLIC":"公开性",
    "STEP_3_NODE_SELECTOR":"节点选择器",
    "STEP_3_NODE_SELECTOR_COMMENT":"选择节点或节点组...",
    "STEP_3_DANGER_MESSAGE":"警告：所创建的容器中，没有可用的端口供外部使用，不能进行下一步操作。",
    "STEP_3_EXTERNAL_MESSAGE":"必须添加一个外部服务配置，且端口正确。",
    "STEP_3_AFFINITY_MESSAGE":"亲和组/反亲和组不能为空",
    "STEP_3_AFFINITY_SETTING":"亲和配置",
    "STEP_3_AFFINITY_GROUP":"亲和组",
    "STEP_3_REVERSE_AFFINITY_GROUP":"反亲和组",
