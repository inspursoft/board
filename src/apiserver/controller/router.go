	...
	ns := beego.NewNamespace("/api",
		beego.NSNamespace("/v1",
			...
			beego.NSRouter("/helm/repositories",
				&HelmController{},
				"get:ListHelmReposAction;post:CreateHelmRepoAction"),
			beego.NSRouter("/helm/repositories/:id([0-9]+)",
				&HelmController{},
				"put:UpdateHelmRepoAction;delete:DeleteHelmRepoAction;get:GetHelmRepoAction"),
			beego.NSRouter("/helm/repositories/:id([0-9]+)/detail",
				&HelmController{},
				"get:GetHelmRepoDetailAction"),
			beego.NSRouter("/helm/repositories/:id([0-9]+)/charts/:chartname(.+)/:chartversion(.+)",
				&HelmController{},
				"get:GetHelmChartDetailAction"),
			beego.NSRouter("/helm/repositories/:id([0-9]+)/charts/:chartname(.+)/:chartversion(.+)/namespace/:namespace(.+)/:name(.+)",
				&HelmController{},
				"post:InstallHelmChartAction"),
