export const LANG_EN_US = {
  ...
  Node: {
    ...
    Node_Detail_Master_Ip: 'Master ip',
    Node_Detail_Node_Password: 'Node password',
    Node_Detail_Master_Password: 'Master password',
    ...
    Node_Detail_Master_Ip_Hint: 'Please input the master ip.',
    Node_Detail_Node_Password_Hint: 'Please input the password of the node.',
    Node_Detail_Master_Password_Hint: 'Please input the master\'s password .',
    ...
    Node_Detail_Error_Master_Repeat: 'Master ip exists.',
