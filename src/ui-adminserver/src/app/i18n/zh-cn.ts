export const LANG_ZH_CN = {
  ...
  Node: {
    ...
    Node_Detail_Master_Password: 'Master密码',
    ...
    Node_Detail_Master_Ip_Hint: '请输入Master IP',
    Node_Detail_Node_Password_Hint: '请输入节点密码',
    Node_Detail_Master_Password_Hint: '请输入Master密码',
    ...
    Node_Detail_Error_Node_Repeat: '节点ip不能重复',
    Node_Detail_Error_Master_Repeat: 'Master ip不能重复',
