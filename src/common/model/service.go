...
type ServiceStatus struct {
	...
	ServiceObjectConfig    string    `json:"service_object_config" orm:"column(service_object_config)"`
	DeploymentObjectConfig string    `json:"deployment_object_config" orm:"column(deployment_object_config)"`
}
